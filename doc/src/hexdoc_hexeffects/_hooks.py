...
import hexdoc_hexeffects

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class HexEffectsPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HexEffectsModPlugin(branch=branch)


class HexEffectsModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hexeffects"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hexeffects, "_templates"
